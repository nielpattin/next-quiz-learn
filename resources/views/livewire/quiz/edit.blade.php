...
<div class="w-full max-w-4xl mx-auto">
    ...
    <form wire:submit="updateQuiz" class="mb-8">
        <div class="bg-[var(--background)] shadow rounded-lg p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <button type="submit" class="px-4 py-2 bg-[var(--color-primary)] hover:bg-[var(--color-tertiary)] text-[var(--color-accent-foreground)] text-sm font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-primary)]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input wire:model="title" id="title" type="text" class="mt-1 block w-full px-3 py-2 border border-[var(--border-color)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] bg-[var(--card-bg)] text-[var(--foreground)]">
                    @error('title') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>

                <div class="md:col-span-2">
                    <label for="description" class="block text-sm font-medium text-[var(--foreground)]">Description</label>
                    <textarea wire:model="description" id="description" rows="3" maxlength="200" class="mt-1 block w-full px-3 py-2 border border-[var(--border-color)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] bg-[var(--card-bg)] text-[var(--foreground)]"></textarea>
                ...
                <div>
                    ...
                    <input wire:model="category" id="category" type="text" placeholder="e.g., Science, History, Math" class="mt-1 block w-full px-3 py-2 border border-[var(--border-color)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] bg-[var(--card-bg)] text-[var(--foreground)]">
                    @error('category') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label for="difficulty_level" class="block text-sm font-medium text-[var(--foreground)]">Difficulty Level *</label>
                    <select wire:model="difficulty_level" id="difficulty_level" class="mt-1 block w-full px-3 py-2 border border-[var(--border-color)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] bg-[var(--card-bg)] text-[var(--foreground)]">
                ...
                <div>
                    ...
                    <input wire:model="time_limit" id="time_limit" type="number" min="1" max="180" class="mt-1 block w-full px-3 py-2 border border-[var(--border-color)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] bg-[var(--card-bg)] text-[var(--foreground)]">
    ...
    <div class="bg-[var(--background)] shadow rounded-lg p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <button type="button" wire:click="addQuestion" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-[var(--color-accent-foreground)] bg-[var(--color-primary)] hover:bg-[var(--color-tertiary)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-primary)]">
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <button wire:click="editQuestion('{{ $question->id }}')"
                                        class="px-3 py-1.5 text-sm text-[var(--foreground)] hover:text-[var(--foreground)] font-medium">
                                    Edit
                                </button>
        ...
        @else
            <div class="text-center py-8">
                ...
                <div class="mt-4">
                    <button wire:click="addQuestion" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-[var(--color-accent-foreground)] bg-[var(--color-accent)] hover:bg-[var(--color-tertiary)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-accent)]">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
                        Add First Question
