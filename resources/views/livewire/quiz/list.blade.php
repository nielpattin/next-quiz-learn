    ...
    <div class="bg-[var(--background)] shadow rounded-lg">
        <div class="p-6 border-b border-[var(--border-color)]">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <a 
                    ...
                    class="inline-flex items-center px-4 py-2 bg-[var(--button-primary-background)] hover:bg-[var(--color-tertiary)] text-[var(--button-primary-foreground)] font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-primary)]"
                >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
            @forelse ($this->getQuizzes() as $quiz)
                <div class="bg-[var(--card-background)] rounded-lg shadow-md border border-[var(--border-color)] hover:shadow-lg transition-shadow duration-200">
